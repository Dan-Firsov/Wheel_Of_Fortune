...
export default function BetPanel() {
  ...
  return (
    <div className={styles.betPanelWrapper}>
      <input
        className={styles.betPanelCheckbox}
        type='checkbox'
        id='checkbox'
        ref={checkboxRef}
      />
      <div className={styles.betPanelFormContainer} ref={formContainerRef}>
        <form className={styles.betPanelForm} onSubmit={handleBet}>
          ...
          <label className={styles.betPanelFormButtonLabel} htmlFor='checkbox'>
            ...
            <Button
              customClass={styles.betPanelFormButtonRemove}
          ...
          <label
            className={styles.betPanelFormToggle}
            htmlFor='checkbox'
            data-title='Place bet'
          ></label>
        </form>
      </div>
    </div>
